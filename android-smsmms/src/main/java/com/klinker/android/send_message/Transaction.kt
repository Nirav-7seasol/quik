...
class Transaction @JvmOverloads constructor(private val context: Context, settings: Settings = Settings()) {
    ...
    companion object {
        ...
        const val MMS_SENT = "com.messages.readmms.readsmss.MMS_SENT"
        const val EXTRA_CONTENT_URI = "content_uri"
        const val EXTRA_FILE_PATH = "file_path"

        const val NOTIFY_SMS_FAILURE = "com.messages.readmms.readsmss.NOTIFY_SMS_FAILURE"
        const val MMS_UPDATED = "com.messages.readmms.readsmss.MMS_UPDATED"
