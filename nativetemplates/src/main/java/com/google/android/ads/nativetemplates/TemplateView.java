...
public class TemplateView extends FrameLayout {
    ...
    public void setNativeAd(NativeAd nativeAd, String buttonColor) {
        ...
        callToActionView.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(buttonColor)));
        adNotificationView.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor(buttonColor)));
...
//      ratingBar.setVisibility(VISIBLE);
    ...
    public void setNativeAd(NativeAd nativeAd, int buttonColor) {
        this.nativeAd = nativeAd;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            callToActionView.setBackgroundTintList(ColorStateList.valueOf(buttonColor));
        }
...
//      ratingBar.setVisibility(VISIBLE);
    ...
    public void onFinishInflate() {
        ...
        adNotificationView = (TextView) findViewById(R.id.ad_notification_view);
