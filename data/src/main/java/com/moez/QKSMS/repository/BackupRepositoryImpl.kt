...
import dev.octoshrimpy.quik.util.QkFileObserver
...
class BackupRepositoryImpl @Inject constructor(
    ...
    override fun performBackup() {
        ...
        try {
            ...
            val dir = File(getBackupDirectoryPath()).apply { mkdirs() }
    ...
    override fun getBackups(): Observable<List<BackupFile>> =
        QkFileObserver(getBackupDirectoryPath()).observable
            .map { File(getBackupDirectoryPath()).listFiles() ?: arrayOf() }
